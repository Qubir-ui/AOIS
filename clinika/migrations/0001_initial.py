    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Person_number', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='clinika.person')),
            ],
        ),
        migrations.AddField(
            model_name='patient',
            name='Person_number',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='clinika.person'),
        ),
        migrations.CreateModel(
            name='Movings',
            fields=[
